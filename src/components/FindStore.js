...
export default function FindStore({ variant = "pink" }) {
  const isDark = variant === "purple";

  return (
    <section
      className={`pb-[31px] pt-[48px] text-center min-[500px]:max-md:portrait:pb-[29px] min-[500px]:max-md:portrait:pt-[43px] md:portrait:pb-[30px] md:portrait:pt-[64px] lg:landscape:pb-[38px] lg:landscape:pt-[64px] xl:py-[58px] ${
        isDark ? "bg-[#720062]" : "bg-[#cc4aa7]"
      }`}
    >
      <style>{`
      ...
      <div className="mx-auto max-w-[1350px] px-[30px] xl:px-8">
        ...
        <button
          className={`mt-[49px] inline-flex h-[50px] w-[318px] max-w-full items-center justify-center gap-2 rounded-full text-[18px] font-bold text-white shadow-[0_12px_20px_rgba(0,0,0,0.45)] transition-all duration-150 active:scale-[0.98] landscape:mt-[53px] min-[500px]:max-md:portrait:mt-[48px] md:portrait:mt-[60px] lg:landscape:mt-[45px] xl:mt-[30px] xl:h-[52px] xl:w-[330px] ${
            isDark ? "bg-[#cc4aa7]" : "bg-[#720062]"
          }`}
